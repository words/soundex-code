...
test('api', function (t) {
  ...
  /* The PHP implementation, based on Knuths, gives
...
test('cli', function (t) {
  ...
  ['-h', '--help'].forEach(function (flag) {
    execa.stdout('./cli.js', [flag]).then(function (result) {
      t.ok(/\s+Usage: soundex-code/.test(result), flag);
    });
  });
